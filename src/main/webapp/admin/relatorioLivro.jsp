...
<div class="container mt-4">    <!-- -->
    ...
    <div>
        <form action="Pesquisa" method="post" onsubmit=" return validaData()" class="form-inline">
            ...
            <input name= "dataInicio" id="dataInicio" class="form-control mr-sm-1" type="date" required>

            <label for="dataFim">Data Final: </label>
            <input id="dataFim" name="dataFim" class="form-control mr-sm-1" type="date" required>
            <button type="submit" class="form-control btn-info" name="operacao" value="PESQUISA_PERIODO">Consultar</button>
        </form>
    </div>

    <div class="col-lg-15 col-md-15 col-sm-15 offset-md-0 offset-sm-1" id="grafico" align="center">
        <!-- GRÁFICO LINHA -->
        <div>
