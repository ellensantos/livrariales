// Adicionar Endereços e Popular Campos de Estado e Cidade
...
//var contador = 1; // É obrigatório cadastrar 1 endereço para entrega e outro para cobrança

//Adicionar Endereço
function adicionarEndereco(){
    var contador = document.getElementById("qtdeEndereco").value;
    contador++;
    console.log(contador);

    document.getElementById("qtdeEndereco").value = contador;

    var elementoNovoEnd = document.getElementById("novoEndereco");
    var divEndereco = document.createElement("div");
    divEndereco.setAttribute('id', 'novoEndereco' + contador);

    elementoNovoEnd.appendChild(divEndereco);
    divEndereco.innerHTML +=

        '<!-- Endereço -->' +
        '<br/><hr class="mb-4">' +
        '<label for="endereco' +contador+ '"><b>ENDEREÇO ' +contador+ ':</b></label>' +
        '<div class="card">' +
        '<div class="card-body">' +

        '<input type="text" name="idEndereco' +contador+ '" id="idEndereco' +contador+ '" value="0" hidden="true">' +

        '<label><b>Tipo de Endereço: &#160;&#160;</b></label>'+
        '<div class="form-check-inline">'+
        '<label class="form-check-label" for="entrega' +contador+ '">'+
        '<input type="checkbox" class="form-check-input" id="entrega' +contador+ '" name="entrega' +contador+ '" value="1">Entrega'+
        '</label>'+

        '</div>'+
        '<div class="form-check-inline">'+
        '<label class="form-check-label" for="cobranca' +contador+ '">'+
        '<input type="checkbox" class="form-check-input" id="cobranca' +contador+ '" name="cobranca' +contador+ '" value="2">Cobrança'+
        '</label>'+
        '</div>'+
        '<hr class="mb-1">'+
        '<br/>'+
        ...
        '<label for="descricaoEnd' +contador+ '">Descrição do Endereço (Apelido)</label>'+
        '<input type="text" class="form-control" id="descricaoEnd' +contador+ '" name="descricaoEnd' +contador+ '" required>'+
        '</div>'+
        '<div class="col-md-3">'+
        '<label for="tipoResidencia' +contador+ '">Tipo de Residência</label>'+
        '<select class="form-control" id="tipoResidencia' +contador+ '" name="tipoResidencia' +contador+ '" required>'+
        ...
        '<div class="form-row">'+
        '<div class="col-md-3">'+
        '<label for="tipoLogradouro' +contador+ '">Tipo Logradouro</label>'+
        '<select class="form-control" id="tipoLogradouro' +contador+ '" name="tipoLogradouro' +contador+ '" required>'+
        '<option selected data-default value=""></option>'+
        ...
        '<input type="text" class="form-control" id="logradouro' +contador+ '" name="logradouro' +contador+ '" required>'+
        '</div>'+

        '<div class="col-md-2">'+
        '<label for="numero' +contador+ '">Número</label>'+
        '<input type="number" class="form-control" id="numero' +contador+ '" name="numero' +contador+ '" min = "0" required>'+
        '</div>'+
        '</div>'+
        '<br/>'+
        ...
        '<input type="text" class="form-control" id="bairro' +contador+ '" name="bairro' +contador+ '" required>'+
        '</div>'+

        '<div class="col-md-3">'+
        '<label for="cep' +contador+ '">CEP</label>'+
        '<input type="text" class="form-control" id="cep' +contador+ '" name="cep' +contador+ '" pattern="[0-9]+$" maxlength="8"  oninvalid = "setCustomValidity("Apenas números")" onchange="setCustomValidity("")" required>'+
        '</div>'+
        '</div>'+
        ...
        '<div class="form-row">'+
        '<div class="col-md-3">'+
        '<label for="pais' +contador+ '">País</label>'+
        '<select class="form-control" id="pais' +contador+ '" name="pais' +contador+ '" required>'+
        ...
        '<select class="form-control" id="estado' +contador+ '" name="estado' +contador+ '" onchange="buscaCidades(this.value, this)" required>'+
        '<option selected data-default value=""></option>'+
        '</select>'+
        '</div>'+
        ...
        '<select class="form-control" id="cidade' +contador+ '" name="cidade' +contador+ '" required>'+
        '</select>'+
        '</div>'+
        '</div>'+

        '<br/>'+
        '<label for="observacao' +contador+ '">Observação</label>'+
        '<textarea class="form-control" rows="3"   id="observacao' +contador+ '" name="observacao' +contador+ '"></textarea>'+

        '<br/>'+
        '<div align="center">'+
        '<button type="button" class="btn btn-danger" name = "remover' +contador+'" id = "remover' +contador+ '" onclick="deletarEndereco(this)">Excluir Endereço '+contador+' </button>'+
        '</div>'+
        '</div> <!-- Card Bory Endereço -->'+
        '</div>';

    popularSelectEstado("estado" + contador);
}

//Excluir Endereço
function deletarEndereco(obj){

    //ID do Botão
    var idBotao = obj.id;

    //O nome do botão chama remover+qtde
    //Recuperando apenas o número do botão
...
/*    //Quantidade Caracter do ID do Botão Recebido
    ...
    console.log("Numero Botão = " + numBotao);

    var elementoEnd = document.querySelector("#novoEndereco" + numBotao);
    elementoEnd.remove();
}

//Popular Select Estado
function popularSelectEstado(nomeCombo) {
...
//Popular Cidades de Acordo com o Estado
function buscaCidades(idEstado, obj){

    //ID do ComboBox
    var idComboBox = obj.id;

    var numCombo = idComboBox.replace("estado", "");

    document.querySelector("#cidade" + numCombo).innerHTML = '';
    var cidade_select = document.querySelector("#cidade" + numCombo);

    var num_cidades = cidades.length;

    console.log("Total de Cidades = " + num_cidades);

    // Contando as cidades
    var contadorCidade  = 0;
    for(var x=0; x<num_cidades; x++){
    ...
    // Criando os options
    var cidadeOptions = document.getElementById("cidade" + numCombo);

    for (var i = 0; i < num_cidades; i++) {
        if(cidades[i].Estado == idEstado){
            cidadeOptions.innerHTML = cidadeOptions.innerHTML +
                '<option value="' + cidades[i]['ID'] + '">' + cidades[i]['Nome'] + '</option>';
        }
    }

    console.log("ID do Estado = " + idEstado)
    console.log("Total de Cidades = " + contadorCidade);
    console.log("Nome do Campo Estado = " + obj.id);

}


function verificarCheckBox() {
    var qtdeEnd = document.getElementById("qtdeEndereco").value;
    var flagCobranca = false;
    var flagEntrega = false;
    var checkCobranca;
    var checkEntrega;

    var checkCampo;

    for(var i = 1; i <= qtdeEnd; i++) {
        checkCobranca = document.getElementById("cobranca" + i);
        checkEntrega = document.getElementById("entrega" + i);

        var j = 0;

        while (j <= 1) {
            if ((checkCobranca.checked != true && checkEntrega.checked != true)) {
                alert("Selecione o tipo de endereço");
                return false;
            }

            if(checkCobranca.checked == true){
                flagCobranca = true;
            }
    ...
    if(!flagCobranca){
        alert("É necessário ao menos um endereço de COBRANÇA.");
        return false;
    }

    if(!flagEntrega){
        alert("É necessário ao menos um endereço de ENTREGA.");
        return false;
    }
...
//Adicionar Endereço
function popularSelectEstadoEdicao(){
    var qtdeEndereco = document.getElementById("qtdeEndereco").value;
    for (var i= 1; i <= qtdeEndereco; i++){
        popularSelectEstado("estado" + i);
    }
}

// Exibir Endereço para o check-out
function exibirEnderecoCheckOut(){

    var select = document.getElementById("idEnderecoSelecionado");
    var valorSelect = (select.selectedIndex);

    esconderEnderecosCheckOut();

    //Exibindo o endereço selecionado
    var divEnd = document.getElementById("cardEnd" + valorSelect);
    divEnd.style.display = "block";
}

function esconderEnderecosCheckOut(){
    var qtdeEndereco = document.getElementById("qtdeEndereco").value;
    //Ocultar todas as Divs de endereço
    for(var i = 1; i<=qtdeEndereco; i++){
        var divEnd = document.getElementById("cardEnd" + i);
        if(divEnd != null) {
            console.log(divEnd);
...
//Adicionando Endereço Check-out
function addEndCheckOut(obj){
    ...
    if(idBotao == "AddEndCobranca"){
        var elementoNovoEnd = document.getElementById("novoEnderecoCobranca");
        divEndereco.setAttribute('id', 'novoEnderecoCobranca1');
        document.getElementById("idEndCobrancaSelecionado").value = 0;
        document.getElementById("selecEndCobrancaCad").style.display = "none";
        select = document.getElementById("idEndCobrancaSelecionado");
        select.removeAttribute('required');
        var descricao = "EndCobranca1";

        console.log(select);
    }
    else if(idBotao == "AddEndEntrega"){
        var elementoNovoEnd = document.getElementById("novoEnderecoEntrega");
        divEndereco.setAttribute('id', 'novoEnderecoEntrega1');
        document.getElementById("idEndEntregaSelecionado").value = 0;
        document.getElementById("selecEndEntregaCad").style.display = "none";
        document.getElementById("valorFrete").value = 0;
        var select = document.getElementById("idEndEntregaSelecionado");
        select.removeAttribute('required');
        var descricao = "EndEntrega1";
        atualizarValorFrete();
    ...
    //var elementoNovoEnd = document.getElementById("novoEndereco");
    //var divEndereco = document.createElement("div");
    //divEndereco.setAttribute('id', 'novoEndereco1');

    elementoNovoEnd.appendChild(divEndereco);
    divEndereco.innerHTML +=

        '<!-- Endereço -->' +
        '<div class="card" id="cardEndCheckOut" style="background-color: #e8ecef;">' +
        '<div class="card-body" id="cardEndCheckOut">' +
        '<div class="form-row">'+
        '<div class="form-group col-md-7">'+
        '<label for="descricao'+descricao+'">Descrição do Endereço (Apelido)</label>'+
        '<input type="text" class="form-control" id="descricao'+descricao+'" name="descricao'+descricao+'" required>'+
        '</div>'+
        '<div class="col-md-5">'+
        '<label for="tipoResidencia'+descricao+'">Tipo de Residência</label>'+
        '<select class="form-control" id="tipoResidencia'+descricao+'" name="tipoResidencia'+descricao+'" required>'+
        '<option selected data-default value=""></option>'+
        '<option>Apartamento</option>'+
        '<option>Bangalô</option>'+
        '<option>Casa</option>'+
        ...
        '<div class="form-row">'+
        '<div class="col-md-5">'+
        '<label for="tipoLogradouro'+descricao+'">Tipo Logradouro</label>'+
        '<select class="form-control" id="tipoLogradouro'+descricao+'" name="tipoLogradouro'+descricao+'" required>'+
        '<option selected data-default value=""></option>'+
        '<option>Aeroporto</option>'+
        '<option>Alameda</option>'+
        '<option>Avenida</option>'+
        ...
        '<div class="col-md-6">'+
        '<label for="logradouro'+descricao+'">Logradouro</label>'+
        '<input type="text" class="form-control" id="logradouro'+descricao+'" name="logradouro'+descricao+'" required>'+
        '</div>'+
        '</div>'+
        '<br/>'+
        ...
        '<div class="form-row">'+
        '<div class="col-md-2">'+
        '<label for="numero'+descricao+'">Número</label>'+
        '<input type="number" class="form-control" id="numero'+descricao+'" name="numero'+descricao+'" min = "0" required>'+
        '</div>'+
        '<br/>'+


        '<div class="col-md-6">'+
        '<label for="bairro'+descricao+'">Bairro</label>'+
        '<input type="text" class="form-control" id="bairro'+descricao+'" name="bairro'+descricao+'" required>'+
        '</div>'+

        '<div class="col-md-3">'+
        '<label for="cep'+descricao+'">CEP</label>'+
        '<input type="text" class="form-control" id="cep'+descricao+'" name="cep'+descricao+'" pattern="[0-9]+$" maxlength="8"  oninvalid = "setCustomValidity("Apenas números")" onchange="calcularFrete()" required>'+
        '</div>'+
        '</div>'+
        ...
        '<div class="form-row">'+
        '<div class="col-md-3">'+
        '<label for="pais'+descricao+'">País</label>'+
        '<select class="form-control" id="pais'+descricao+'" name="pais'+descricao+'" required>'+
        '<option selected data-default value="1">Brasil</option>'+
        '</select>'+
        '</div>'+

        '<div class="col-md-3">'+
        '<label for="estado'+descricao+'">Estado</label>'+
        '<select class="form-control" id="estado'+descricao+'" name="estado'+descricao+'" onchange="buscaCidades(this.value, this)" required>'+
        '<option selected data-default value=""></option>'+
        '</select>'+
        '</div>'+

        '<div class="col-md-3">'+
        '<label for="cidade'+descricao+'">Cidade</label>'+
        '<select class="form-control" id="cidade'+descricao+'" name="cidade'+descricao+'" required>'+
        '</select>'+
        '</div>'+
        '</div>'+

        '<br/>'+
        '<label for="observacao'+descricao+'">Observação</label>'+
        '<textarea class="form-control" rows="3"   id="observacao'+descricao+'" name="observacao'+descricao+'"></textarea>'+


        '<div class="form-check-inline">'+
        '<label class="form-check-label" for="salvar'+descricao+'">'+
        '<br/>'+
        '<input type="checkbox" class="form-check-input" id="salvar'+descricao+'" name="salvar'+descricao+'"> Salvar Endereço'+
        '</label>'+
        '</div>'+
        ...
        '<br/>'+
        '<div align="center">'+
        '<button type="button" class="btn btn-danger btn-sm" name = "remover'+descricao+'" id = "remover'+descricao+'" onclick="removerEndCheckOut(this)">Remover </button>'+
        '</div> <!-- Card Bory Endereço -->'+
        '</div>';

    popularSelectEstado("estado" + descricao);


/*    // document.getElementById("botaoAddEnd").style.display = "none";
    document.getElementById("idEnderecoSelecionado").value = 0;
/!*    document.getElementById("idEnderecoSelecionado").style.display = "none";
    document.getElementById("labelSelectEnd").style.display = "none";*!/

    document.getElementById("selecaoEndCadastro").style.display = "none";*/
}

function removerEndCheckOut(obj){

    var idBotao = obj.id;

    if(idBotao == "removerEndCobranca1"){
        var elementoEnd = document.querySelector("#novoEnderecoCobranca1");
        elementoEnd.remove();
        var select = document.getElementById("idEndCobrancaSelecionado");
        select.value = 0;
        document.getElementById("selecEndCobrancaCad").style.display = "block";
        select.setAttribute('required', 'required');

    }
    else if(idBotao == "removerEndEntrega1"){
        var elementoEnd = document.querySelector("#novoEnderecoEntrega1");
        elementoEnd.remove();
        var select = document.getElementById("idEndEntregaSelecionado");
        select.value = 0;
        document.getElementById("selecEndEntregaCad").style.display = "block";
        select.setAttribute('required', 'required');
        document.getElementById("valorFrete").value = 0;
        atualizarValorFrete();
