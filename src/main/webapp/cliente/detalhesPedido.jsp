        ...
        <div class="col-lg-9 my-lg-0 my-1" class="bg-white border">
            <div id="main-content">
                ...
                <form action="Pedido" method="post">
                    <div class="card" id = "card-cadastro">
                        <div class="card-body" id = "card-cadastro">
                            <c:if test="${pedidoDetalhes[0]['class'].simpleName eq 'PedidoCompra'}">
                                ...
                                <br><br>
                                <table class="table table-striped table-light"style="font-size: 13px" id="tabelaItens">
                                    ...
                                    <c:forEach var="item" items="${pedidoDetalhes[0].itens}" varStatus="cont">
                                        <tr>
                                            ...
                                            <th scope="col">
                                                ...
                                                <c:if test="${not empty item.pedidoTroca and item.pedidoTroca.status ne 'PRODUTO_RECEBIDO'}">
                                                    <a href="/ellentex-livrariales/Pedido?operacao=PEDIDO_DETALHES_CLIENTE&idPedido=${item.pedidoTroca.id}">Troca: #${item.pedidoTroca.id}</a>
                                                </c:if>

                                                <c:if test="${not empty item.pedidoTroca and item.pedidoTroca.status eq 'PRODUTO_RECEBIDO'}">
                                                    <a href="/ellentex-livrariales/Pedido?operacao=PEDIDO_DETALHES_CLIENTE&idPedido=${item.pedidoTroca.id}">Trocado</a>
                                                </c:if>
                                            </th>
                                        </tr>
                                    </c:forEach>
                    ...
                    <a href="/ellentex-livrariales/Cliente?operacao=CONSULTAR_PEDIDOS">Retornar ao Histórico de Pedidos</a>
                </form>
            </div>
        </div>
    </div>
