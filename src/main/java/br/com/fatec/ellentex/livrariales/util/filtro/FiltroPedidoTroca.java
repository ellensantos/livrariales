...
public class FiltroPedidoTroca {

    public TypedQuery<EntidadeDominio> criarQuery(PedidoTroca pedido, EntityManager entityManager) {
        CriteriaBuilder builder = entityManager.getCriteriaBuilder();
        CriteriaQuery<EntidadeDominio> cQuery = builder.createQuery(EntidadeDominio.class);
        Root<PedidoTroca> root = cQuery.from(PedidoTroca.class);
